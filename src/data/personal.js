...
export const personalInfo = {
  ...
  subtitle: "Building Intelligent Applications & Scalable Web Solutions",
  ...
  hero: {
    greeting: "Hi, I'm",
    tagline: "I craft intelligent applications that bridge the gap between cutting-edge AI and beautiful user experiences.",
    description: "Full Stack Developer and AI Engineer with 1.5+ years of experience in building production-grade applications. I specialize in creating scalable web solutions using React and FastAPI, while leveraging AI/ML technologies to solve complex real-world problems.",
